    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-end space-y-2 text-sm">
          <p>Suporte: <a href="tel:+258123456789" className="underline hover:text-[#0A7307]">+258 123 456 789</a></p>
          <p>Email: <a href="mailto:support@interrota.com" className="underline hover:text-[#0A7307]">support@interrota.com</a></p>
          <div className="flex gap-4 mt-1">
            {/* Ícones SVG minimalistas */}
            <a href="https://facebook.com/interrota" aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="hover:text-[#0A7307]">
            ...
            <a href="https://twitter.com/interrota" aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="hover:text-[#0A7307]">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://instagram.com/interrota" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="hover:text-[#0A7307]">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
